...
const { generateFingerprint, toPlaywrightContext, toAxiosHeaders } = require('../proxy/fingerprint');
    ...
    getScrapingContext(options = {}) {
        ...
        return {
            ...
            playwrightConfig: proxy ? {
                ...
                proxy: proxyUrl ? require('../proxy/proxyPool').ProxyPool.parseProxyUrl(proxyUrl) : undefined,
            } : toPlaywrightContext(fingerprint),
        };
    }
